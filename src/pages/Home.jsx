...
export default function Home() {
  return (
    <div className="space-y-24">
      ...
      {/* 1. HERO SECTION (Sesuai kodingan dasar lu, src img disesuaikan pake variabel import) */}
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 min-h-[calc(100vh-160px)] py-6">
        ...
        <div className="flex-1 max-w-2xl space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4 pt-4">
            <button className="w-full sm:w-auto px-6 py-3 bg-brand hover:bg-brand-hover text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-brand/20 hover:-translate-y-0.5">
              View Projects 
              {/* Icon Panah Kanan */}
        ...
        {/* BAGIAN KANAN: Tempat Foto dengan Frame Rounded unik */}
        <div className="flex-1 flex justify-center lg:justify-end relative">
          {/* Dekorasi background bayangan halus di belakang foto */}
          ...
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-[380px] lg:h-[380px] rounded-[2.5rem] overflow-hidden bg-slate-200 dark:bg-slate-800 border-4 border-white dark:border-slate-900 shadow-2xl">
            {/* Diubah src-nya menggunakan variabel fotoBaim dari import biar ga broken link pas build */}
            <img 
              src={fotoBaim} 
      ...
      {/* 2. ABOUT SECTION (Dipanggil di bawah Hero) */}
      <About />
      <Projects />
      <Contact />
